...
These accounts are required for MediaWiki image installation and configuration

## MediaWiki

Administrator account is set by yourselft at the time of MediaWiki installation wizard
